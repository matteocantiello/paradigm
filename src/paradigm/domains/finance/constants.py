...
LITERATURE_INSTRUCTION = (
    ...
    "(e.g., 2301.12345 for arXiv, or an SSRN ID), NOT a URL. Only use IDs that "
    "appeared in real search results — **never invent or guess a paper ID** "
    "(invented IDs resolve to unrelated papers and are rejected).\n\n"
    "### Writing search queries\n"
    "- Use **2-3 plain keywords** — the core subject terms only "
    "(e.g. `momentum factor returns` or `yield curve recession`).\n"
    ...
    "you have already found papers, switch to [FOLLOW:]/[CITED_BY:] on those. If "
