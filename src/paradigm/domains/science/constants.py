...
LITERATURE_INSTRUCTION = (
    ...
    "  Wired archives: VizieR/CDS catalogs, MAST (Hubble/Webb/TESS/Kepler), "
    "IRSA (WISE/2MASS/Spitzer), NED (extragalactic), the NASA Exoplanet "
    "Archive, SIMBAD (object cross-match — resolve a name to coordinates/type), "
    "and Zenodo (general data).\n"
    ...
    "  [FETCHDATA: vizier:J/A+A/701/A297]   (or mast:… / irsa:… / exoplanet:ps "
    "/ simbad:Betelgeuse / zenodo:…)\n\n"
