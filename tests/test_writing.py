...
def _make_writing_factory():
    ...
    section_responses = {
        "writer": (
            ...
            "width and core hydrogen burning lifetime. Our analysis reveals that "
            "overshooting extends the main-sequence lifetime by 15-25% for stars in "
            "the 1.5-8 solar mass range, with significant implications for age "
            "determinations of stellar clusters and populations.\n\n"
            ...
            "The treatment of convective boundaries remains one of the largest "
            "uncertainties in stellar evolution theory. Classical mixing-length theory "
            "(MLT) provides a local description of convection but does not predict "
            "the extent of mixing beyond formally stable boundaries. Overshooting — "
            "the penetration of convective motions into radiatively stable layers — "
            "has profound effects on stellar structure, nucleosynthesis, and observable "
            "properties of stars across a wide range of masses.\n\n"
            "Previous studies have parameterized overshooting as a fraction of the "
            "pressure scale height (f_ov), with values ranging from 0.01 to 0.03 "
            "depending on stellar mass, evolutionary state, and calibration method. "
            "However, systematic uncertainties persist, particularly regarding the "
            "mass dependence of f_ov and its effect on the main-sequence width in "
            "the Hertzsprung-Russell diagram.\n\n"
            "## Methods\n\nWe use one-dimensional stellar evolution models computed "
            "with the MESA code (version r23.05.1) to investigate the effects of "
            "convective overshooting on the main-sequence width. Our models span a "
            "mass range of 1.5 to 8 solar masses with initial metallicity Z = 0.014 "
            "and helium fraction Y = 0.266. For each mass, we compute evolutionary "
            "tracks with overshooting parameters f_ov = 0.000, 0.005, 0.010, 0.015, "
            "0.020, 0.025, and 0.030 using the exponential diffusive scheme.\n\n"
            "## Results\n\nOur results show that convective overshooting significantly "
            "affects the main-sequence lifetime and core hydrogen burning efficiency. "
            "For a 3 solar mass star, increasing f_ov from 0.000 to 0.020 extends "
            "the main-sequence lifetime from 284 Myr to 347 Myr (a 22% increase). "
            "The convective core mass at the TAMS increases by approximately 18%, "
            "leading to a more luminous and cooler turnoff point. Statistical "
            "comparison with observed eclipsing binaries yields a best-fit "
            "overshooting parameter of f_ov = 0.016 +/- 0.004.\n\n"
            "## Discussion\n\nThese results have important implications for stellar "
            "population synthesis and cluster age determinations. The mass dependence "
            "of the overshooting effect suggests that a single parameter may be "
            "insufficient to describe the physics across the full mass range.\n\n"
